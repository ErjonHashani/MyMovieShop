  ...
  footer_container.innerHTML = `
        <div class="container mx-auto px-16 py-7">
            <div class="text-gray-200 md:flex justify-between items-center">
                ...
                <!-- Shop -->
                <div class="w-60 md:w-48 lg:w-auto self-baseline bg-gray-200 hover:scale-105 duration-500">
                    <a href="cart.html" class="flex justify-center items-center gap-2 text-gray-700 py-2 px-3">Purchase now 
