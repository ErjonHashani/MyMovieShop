                ...
                <div class="hidden lg:flex lg:items-center gap-16">
                    ...
                    <nav>
                        <ul class="flex gap-5">
                            ${isLoggedIn ? 
                                `<li>
                                    <a href="#" id="logoutBtn" class="flex gap-2 items-center text-base font-normal py-2 px-4 rounded-lg bg-gradient-to-r from-gray-500 to-gray-600 hover:from-gray-600 hover:to-gray-700 transition-all duration-200 shadow-md hover:shadow-lg">
                                        <div><svg class="w-4 h-4" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M246.6 9.4c-12.5-12.5-32.8-12.5-45.3 0l-128 128c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 109.3 192 320c0 17.7 14.3 32 32 32s32-14.3 32-32l0-210.7 73.4 73.4c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3l-128-128zM64 352c0-17.7-14.3-32-32-32s-32 14.3-32 32l0 64c0 53 43 96 96 96l256 0c53 0 96-43 96-96l0-64c0-17.7-14.3-32-32-32s-32 14.3-32 32l0 64c0 17.7-14.3 32-32 32L96 448c-17.7 0-32-14.3-32-32l0-64z"/></svg></div>
                                        Logout
                                    </a>
                                </li>` 
                                : 
                                `<li>
                                    <a href="login.html" class="flex gap-2 items-center text-base font-normal py-2 px-4 rounded-lg bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 transition-all duration-200 shadow-md hover:shadow-lg transform">
                            ...
                            ${!isLoggedIn ? `
                                <li>
                                    <a href="register.html" class="flex gap-2 items-center text-base font-normal py-2 px-4 rounded-lg bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 transition-all duration-200 shadow-md hover:shadow-lg transform">
